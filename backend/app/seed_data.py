...
PERMISSION_DEFINITIONS = [
    ...
    ("customer:sensitive:identity", "Xem đầy đủ CCCD và mã số thuế", "Dữ liệu nhạy cảm"),
    ("customer:sensitive:contact", "Xem đầy đủ điện thoại và địa chỉ", "Dữ liệu nhạy cảm"),
    ("customer:sensitive:account", "Xem đầy đủ số tài khoản và sổ tiết kiệm", "Dữ liệu nhạy cảm"),
    ("customer:sensitive:transaction", "Xem chi tiết nội dung giao dịch", "Dữ liệu nhạy cảm"),
    ("customer:sensitive:loan", "Xem đầy đủ LDS và chi tiết khoản vay", "Dữ liệu nhạy cảm"),
    ("customer:sensitive:copy", "Sao chép dữ liệu nhạy cảm", "Dữ liệu nhạy cảm"),
