  ...
  const tabItems = [
    {
      ...
      children: (
        <>
          ...
          <Row gutter={[16, 16]} className="demo-section">
            <Col xs={24} lg={8}><ServiceGroup title="Ngân hàng điện tử" icon={<GlobalOutlined />} items={[
            ...
            <Col xs={24} lg={8}><ServiceGroup title="Sản phẩm thẻ" icon={<CreditCardOutlined />} items={[
            ...
            <Col xs={24} lg={8}><ServiceGroup title="ABIC" icon={<ShopOutlined />} items={[
