const rows = [
  ['MCN', 'Mã IPCAS chi nhánh', 'Thông tin KH', 'C', 'User–CIF / DP01 / BC06 / LN01 / CIF', 1],
  ...
  ['MACB', 'Mã cán bộ quản lý khách hàng', 'Thông tin KH', 'C', 'User–CIF / DP01 / LN01', 1],
  ['TENCB', 'Tên cán bộ quản lý khách hàng', 'Thông tin KH', 'C', 'User–CIF / DP01 / LN01', 1],

  ['NGAY_UPDATE', 'Ngày giao dịch gần nhất trên TKTT', 'Tiền gửi', 'D', 'GL02', 1],
  ['TKTT1', 'Tài khoản thanh toán chính thứ nhất', 'Tiền gửi', 'C', 'DP01 + PF14', 1],
  ['TKTT2', 'Tài khoản thanh toán chính thứ hai', 'Tiền gửi', 'C', 'DP01 + PF14', 1],
  ['TKTT3', 'Tài khoản thanh toán chính thứ ba', 'Tiền gửi', 'C', 'DP01 + PF14', 1],
  ...
  ['DS_TKTT', 'Doanh số tài khoản thanh toán', 'Tiền gửi', 'N', 'GL02', 1],
  ...
  ['HKD_TK', 'Tài khoản hộ kinh doanh', 'Tiền gửi', 'L', 'DP01.CUST_TYPE=570', 1],
  ...
  ['DUNO_NHTT', 'Dư nợ ngắn hạn thông thường', 'Tiền vay', 'N', 'PF10', 1],
  ['DUNO_NHTTBQ', 'Dư nợ ngắn hạn bình quân', 'Tiền vay', 'N', 'PF10', 1],
  ['DUNO_TDHTT', 'Dư nợ trung dài hạn thông thường', 'Tiền vay', 'N', 'PF10', 1],
  ['DUNO_TDHTTBQ', 'Dư nợ trung dài hạn bình quân', 'Tiền vay', 'N', 'PF10', 1],
  ['DUNO_TC', 'Dư nợ thấu chi cuối kỳ', 'Tiền vay', 'N', 'PF10', 1],
  ['DUNO_TCBQ', 'Dư nợ thấu chi bình quân', 'Tiền vay', 'N', 'PF10', 1],
  ['DUNO_XAU', 'Dư nợ nhóm 3, 4, 5', 'Tiền vay', 'N', 'LN01', null],
  ['DUNO_XAUBQ', 'Dư nợ xấu bình quân', 'Tiền vay', 'N', 'LN01', null],
  ['DUNO_XLRR', 'Dư nợ xử lý rủi ro cuối tháng', 'Tiền vay', 'N', 'RR01', 1],
  ['DS_THUNO_XLRR', 'Doanh số thu nợ XLRR trong tháng', 'Tiền vay', 'N', 'RR01', 1],
  ['DPRR_CHUNG_TT', 'DPRR chung tín dụng trong tháng', 'Tiền vay', 'N', 'LN01', 1],
  ['DPRR_CHUNG_LK', 'DPRR chung tín dụng lũy kế', 'Tiền vay', 'N', 'LN01', 1],
  ['DPRR_CUTHE_TT', 'DPRR cụ thể tín dụng trong tháng', 'Tiền vay', 'N', 'BC29', 1],
  ['DPRR_CUTHE_LK', 'DPRR cụ thể tín dụng lũy kế', 'Tiền vay', 'N', 'BC29', 1],
  ...
  ['PHI_BAOLANH', 'Phí bảo lãnh', 'Phí thu được', 'N', 'KH02', 1],
  ['PHI_CHUYENTIEN', 'Phí chuyển tiền', 'Phí thu được', 'N', 'KH02', 1],
  ...
  ['PHI_NHDT', 'Phí ngân hàng điện tử', 'Phí thu được', 'N', 'KH02', 1],
  ['ABIC_BATD', 'Phí Bảo an tín dụng', 'Phí thu được', 'N', 'KH02', 1],
  ...
  ['THUHO_DIEN', 'Thu hộ tiền điện', 'Bill Payment', 'L', 'Bill Payment + DP01', 1],
  ['THUHO_NUOC', 'Thu hộ tiền nước', 'Bill Payment', 'L', 'Bill Payment + DP01', 1],
  ...
  ['ABIC_BATK', 'Bảo an tài khoản', 'ABIC', 'L', 'Bill Payment + DP01', 1],
  ['ABIC_BATHE', 'Bảo an chủ thẻ', 'ABIC', 'L', 'Bill Payment + DP01', 1],
